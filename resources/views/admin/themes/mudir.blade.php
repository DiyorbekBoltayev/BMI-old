                    ...
                    <tr>
                        <th>
                            <select name="semester" class="form-select" id="select0">
                                ...
                                <option @if($options->semester=='9-semestr') selected @endif value="9-semestr">9-semestr</option>
                                <option @if($options->semester=='10-semestr') selected @endif value="10-semestr">10-semestr</option>
                            </select>
                        </th>
                        <th>
